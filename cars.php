...
<body>
    ...
    <section>
        <h1 style="padding-top:100px; margin-bottom:50px;text-align:center; color:#444444">Наш автопарк</h1>
</section>
    
    <?php include("view/blocks/searchform.php"); ?>
    <?php include("view/blocks/carlist.php"); ?>
